...
<div class="min-h-screen flex items-center justify-center bg-gray-300">
    <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
        <h1 class="text-2xl font-bold text-gray-700 mb-6">Subir archivo PRIVADO</h1>

        <form action="{{ route('upload.storeprivate') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
